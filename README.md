...
The aim of this category of NFTs is to showcase NFT projects that have stood the test of time, remained well know in the community, hold their value well, and have amazing, hardworking teams behind them. 
...
- [Yummi Universe](yummiuniverse.com) [YUMMI] - Yummi Universe plans to bring creatures like Pokemon and Digimon to Cardano in a universe that encourages players to battle together, trade with each other and most of all, have fun. 
...
- [Pavia](pavia.io) [PAVIA] - Pavia is the first and largest metaverse project by land count (100,000) parcels on the Cardano blockchain. 
...
- [Cornucopia](cornucopias.io) [COPI] - Cornucopias 'The Island' is a massive Play-To-Earn, Build-To-Earn, and Learn-To-Earn blockchain based game where players can be rewarded with and/or own land, properties and other NFT based assets with real-world value all by playing games in a fun and safe Metaverse.
...
[NFT-MAKER](nft-maker.io) [NMKR] - NFT-MAKER is the premier product on the Cardano blockchain for creating and minting NFTs and their metadata, with many more services to come. 
...
- [SundaeSwap](sundaeswap.finance) [SUNDAE] - SundaeSwap was the first AMM style DEX live on Cardano and paved the way for many projects and Cardano protocol upgrades. It still provides a good user experience for swapping. They also allow for providing liquidity and yield farming. 

- [MuesliSwap](muesliswap.com) [MILK] - MuesliSwap was the first DEX to go live on Cardano, featuring fixed order book style trading. It is still a fan favorite. 

- [Wingriders](wingriders.com) [WRT] - Wingriders is a DEX that integrates with the Milkomeda EVM compatible side chain, which allows swaps with both native assets and sidechain assets. They also allow for providing liquidity and yield farming. 

- [Maladex](maladex.com) [MAL]  - Maladex is being held up to be the most heavily researched and top of the line DEXes on release later this year. One of the most exciting possibilities from this project is their confidence in reducing or eliminating impermanent loss in liquidity providing. 
...
- [DripDropz](dripdropz.io) [DRIP] - DripDropz allows projects to distribute their tokens to whatever audience parameters they choose (I.e. certain stakepools only, certain token holders, outside parameters, etc). 
...
- Jack (@jackfriks) - Community Member, YouTuber, NFT connoisseur, Memelord
...
- Patrick Tobler (@Padierfind) - Community Member, Developer, NFT-MAKER
